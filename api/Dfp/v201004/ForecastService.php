...
class ApiError {
  ...
  public function getNamespace() {
    return "https://www.google.com/apis/ads/publisher/v201004";
  }
...
class Forecast {
  ...
  public function __construct($id = NULL, $orderId = NULL, $unitType = NULL, $availableUnits = NULL, $deliveredUnits = NULL, $forecastUnits = NULL, $possibleUnits = NULL, $reservedUnits = NULL) {
...
class LineItemSummary {
  ...
  /**
   * @access public
   * @var tnsLineItemSummaryStartType
   */
  public $startType;
...
class Targeting {
  ...
  public function __construct($inventoryTargeting = NULL) {
...
if (!class_exists("LineItemSummaryStartType", FALSE)) {
/**
 * Specifies the start type to use for the {@link LineItem}.
 * @package GoogleApiAdsDfp
 * @subpackage v201004
 */
class LineItemSummaryStartType {
  /**
   * Gets the namesapce of this class
   * @return the namespace of this class
   */
   ...
   */
  public function getXsiTypeName() {
    return "LineItemSummary.StartType";
  }

  public function __construct() {
    if(get_parent_class('LineItemSummaryStartType')) parent::__construct();
  }
}}
...
class ForecastService extends DfpSoapClient {
  ...
  public static $classmap = array(
    ...
    "LineItemSummary.StartType" => "LineItemSummaryStartType",
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201004/ForecastService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ForecastService', 'https://www.google.com/apis/ads/publisher/v201004');
  }

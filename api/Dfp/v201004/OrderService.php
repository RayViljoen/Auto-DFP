...
class Order {
  ...
  public function __construct($id = NULL, $name = NULL, $startDateTime = NULL, $endDateTime = NULL, $unlimitedEndDateTime = NULL, $status = NULL, $isArchived = NULL, $notes = NULL, $externalId = NULL, $currencyCode = NULL, $advertiserId = NULL, $creatorId = NULL, $traffickerId = NULL, $salespersonId = NULL, $totalImpressionsDelivered = NULL, $totalClicksDelivered = NULL, $totalBudget = NULL) {
...
class OrderService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201004/OrderService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'OrderService', 'https://www.google.com/apis/ads/publisher/v201004');
  }

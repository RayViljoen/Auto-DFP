...
class ReportQuery {
  ...
  public function __construct($dimensions = NULL, $columns = NULL, $startDateTime = NULL, $endDateTime = NULL, $dateRangeType = NULL, $dimensionFilters = NULL) {
...
class ReportService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201004/ReportService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ReportService', 'https://www.google.com/apis/ads/publisher/v201004');
  }

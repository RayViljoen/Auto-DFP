...
if (!class_exists("DeleteCustomTargetingKeyAction", FALSE)) {
/**
 * Represents the delete action that can be performed on
 * {@link CustomTargetingKey} objects. Deleting a key will not delete the
 * {@link CustomTargetingValue} objects associated with it. Also, if a custom
 ...
 * @subpackage v201101
 */
class DeleteCustomTargetingKeyAction extends DeleteCustomTargetingKeys {
  /**
   * Gets the namesapce of this class
   * @return the namespace of this class
   */
   ...
   */
  public function getXsiTypeName() {
    return "DeleteCustomTargetingKeyAction";
  }

  public function __construct($CustomTargetingKeyActionType = NULL) {
    if(get_parent_class('DeleteCustomTargetingKeyAction')) parent::__construct();
    $this->CustomTargetingKeyActionType = $CustomTargetingKeyActionType;
  }
}}

if (!class_exists("DeleteCustomTargetingValueAction", FALSE)) {
/**
 * Represents the delete action that can be performed on
 * {@link CustomTargetingValue} objects.
 * @package GoogleApiAdsDfp
 * @subpackage v201101
 */
class DeleteCustomTargetingValueAction extends DeleteCustomTargetingValues {
  /**
   * Gets the namesapce of this class
   * @return the namespace of this class
   */
   ...
   */
  public function getXsiTypeName() {
    return "DeleteCustomTargetingValueAction";
  }

  public function __construct($CustomTargetingValueActionType = NULL) {
    if(get_parent_class('DeleteCustomTargetingValueAction')) parent::__construct();
    $this->CustomTargetingValueActionType = $CustomTargetingValueActionType;
  }
}}
...
class CustomTargetingService extends DfpSoapClient {
  ...
  public static $classmap = array(
    ...
    "DeleteCustomTargetingKeyAction" => "DeleteCustomTargetingKeyAction",
    "DeleteCustomTargetingKeys" => "DeleteCustomTargetingKeys",
    "CustomTargetingKeyAction" => "CustomTargetingKeyAction",
    "DeleteCustomTargetingValueAction" => "DeleteCustomTargetingValueAction",
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201101/CustomTargetingService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CustomTargetingService', 'https://www.google.com/apis/ads/publisher/v201101');
  }

...
try {
  ...
  $targetPlacementIds = array((float) 'INSERT_PLACEMENT_ID_HERE');
  ...
  $geoTargeting->targetedLocations =
      array(new CountryLocation('US'), new RegionLocation('CA-QC'));

  // Exclude Chicago and the New York metro area.
  $geoTargeting->excludedLocations =
      array(new CityLocation('Chicago', NULL, 'US'), new MetroLocation('501'));
  ...
  for ($i = 0;  $i < 5; $i++) {
    ...
    $lineItem->creativeSizes = array(new Size(300, 250));

...
try {
  ...
  $orderService = $user->GetOrderService('v201107');

  // Set the advertiser (company), salesperson, and trafficker to assign to each
  // order.
  $advertiserId = (float) 'INSERT_ADVERTISER_COMPANY_ID_HERE';
  $salespersonId = (float) 'INSERT_SALESPERSON_ID_HERE';
  $traffickerId = (float) 'INSERT_TRAFFICKER_ID_HERE';

...
class AdUnit {
  ...
  public function __construct($id = NULL, $parentId = NULL, $name = NULL, $description = NULL, $targetWindow = NULL, $status = NULL, $adUnitCode = NULL, $sizes = NULL, $inheritedAdSenseSettings = NULL) {
...
class InventoryService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201004/InventoryService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'InventoryService', 'https://www.google.com/apis/ads/publisher/v201004');
  }

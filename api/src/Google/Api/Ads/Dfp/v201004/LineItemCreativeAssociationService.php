...
class LineItemCreativeAssociation {
  ...
  public function __construct($lineItemId = NULL, $creativeId = NULL, $manualCreativeRotationWeight = NULL, $startDateTime = NULL, $endDateTime = NULL, $destinationUrl = NULL, $sizes = NULL, $status = NULL, $stats = NULL) {
...
class LineItemCreativeAssociationService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201004/LineItemCreativeAssociationService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'LineItemCreativeAssociationService', 'https://www.google.com/apis/ads/publisher/v201004');
  }
